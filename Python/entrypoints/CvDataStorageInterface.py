...
class dataStorage:
	...
	def __init__(self):
                self.ffhFolderName = "Master of Mana"
        ...
        def readFile(self, path):
                try :
                        ...
                        print " MoM -> can t read file " + repr(path)
        ...
        def writeFile(self, path, dictData):
                try:
                        ...
                        print " MoM -> can t write file " + repr(path)
                        print traceback.format_exc()
                        return False
        ...
        def createFolder(self, path):
                try :
                        ...
                        print " MoM -> can t create folder " + repr(path)
                        print traceback.format_exc()
                        return False
        ...
        def getDocFolder(self):
                try:
                        ...
                        print " MoM -> can t join MoM doc Folders :"
                        print traceback.format_exc()
                        return ""
        ...
        def getValue(self, lTags):
                try :
                        ...
                        print " MoM -> can t get value : " + repr(lTags)
                        print traceback.format_exc()
                        return False, -1
        ...
        def setValue(self, lTags, value):
                try :
                        ...
                        print " MoM -> can t set value : " + repr(lTags)
                        print traceback.format_exc()
