...
import CvWMGameUtils

wm= CvWMGameUtils.CvWMGameUtils()
...
def AI_ChoosePromotionSpecialization(argsList):
	return wm.AI_ChoosePromotionSpecialization(argsList)

def AI_AnimalLairExplored(argsList):
	return wm.AI_AnimalLairExplored(argsList)

def AI_CivicValue(argsList):
	return wm.AI_CivicValue(argsList)

def Revolution(argsList):
	return wm.Revolution(argsList)

def CorporationOffersSupport(argsList):
	return wm.CorporationOffersSupport(argsList)

def AdventureFinished(argsList):
	return wm.AdventureFinished(argsList)

def Trigger_MagicScreenPopup(argsList):
	return wm.Trigger_MagicScreenPopup(argsList)

def Trigger_MagicScreenPopupEnd(argsList):
	return wm.Trigger_MagicScreenPopupEnd(argsList)

def Trigger_GuildScreenPopup(argsList):
	return wm.Trigger_GuildScreenPopup(argsList)

def Trigger_GuildScreenPopupEnd(argsList):
	return wm.Trigger_GuildScreenPopupEnd(argsList)

def canCityHaveReligion(argsList):
	return wm.canCityHaveReligion(argsList)

def CalculateCivCounter(argsList):
	return wm.CalculateCivCounter(argsList)

def NetMessage_SendTerraformPlan(argsList):
	return wm.NetMessage_SendTerraformPlan(argsList)

def CreateCityStates(argsList):
	return wm.CreateCityStates(argsList)
