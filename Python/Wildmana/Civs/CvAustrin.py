...
#				CyInterface().addImmediateMessage('Starting new civ code...', "AS2D_NEW_ERA")
			...
			#/LordShaggynator
			unwantedCivsList = [iPirate, iAnimal, iOrc, iRandom, iInfernals, iMercurians, iFrozen, iWhiteHand, iDevils, iJotnar, iAristrakh, iMercenaries, iWildmana, iUnblemished]
			availableCivs = list()
			taken = True
