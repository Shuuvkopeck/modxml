...
class SevoPediaHistory:
	...
	def getCivilopedia(self, iEntry):
		...
		elif (self.top.iCategory == SevoScreenEnums.PEDIA_WILDMANA_CONCEPTS):
			info = gc.getWildmanaConceptInfo(iEntry)
		elif (self.top.iCategory == SevoScreenEnums.PEDIA_WILDMANA_GUIDES):
			info = gc.getWildmanaGuideInfo(iEntry)						
		else:
