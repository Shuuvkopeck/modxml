...
import SevoPediaSpellResearch
import SevoPediaUnit
import SevoPediaSummon
...
import SevoPediaProjectTerraform
import SevoPediaProjectGlobal
import SevoPediaSummonRitual
...
##--------	BUGFfH: End Add
		...
		self.mapListGenerators = {
			...
			SevoScreenEnums.PEDIA_SPELLRESEARCH	: self.placeSpellResearch,			
			SevoScreenEnums.PEDIA_UNITS			: self.placeUnits,
			SevoScreenEnums.PEDIA_SUMMONS		: self.placeSummons,			
#			SevoScreenEnums.PEDIA_UNIT_UPGRADES	: self.placeUnitUpgrades,
##--------	BUGFfH: Added by Denev 2009/08/12
			SevoScreenEnums.PEDIA_HEROES		: self.placeHeroes,
##--------	BUGFfH: End Add
			SevoScreenEnums.PEDIA_UNIT_CATEGORIES	: self.placeUnitCategories,
			SevoScreenEnums.PEDIA_PROMOTIONS	: self.placePromotions,
			SevoScreenEnums.PEDIA_PROMOTIONS_CLASS	: self.placePromotionsClass,
			SevoScreenEnums.PEDIA_PROMOTIONS_DISCIPLINE	: self.placePromotionsDiscipline,
			SevoScreenEnums.PEDIA_PROMOTIONS_HEROIC	: self.placePromotionsHeroic,
...
##--------	BUGFfH: Added by Denev 2009/08/12
			...
			SevoScreenEnums.PEDIA_GEAR			: self.placeGear,			
...
##--------	BUGFfH: End Add
			...
			SevoScreenEnums.PEDIA_DISTRICTS		: self.placeDistricts,			
			SevoScreenEnums.PEDIA_PALACES		: self.placePalaces,						
			...
			SevoScreenEnums.PEDIA_CITY_ENCHANTMENTS	: self.placeCityEnchantments,			
			SevoScreenEnums.PEDIA_PROJECTS		: self.placeProjects,
			SevoScreenEnums.PEDIA_PROJECTGLOBALS	: self.placeProjectGlobal,			
			SevoScreenEnums.PEDIA_PROJECTTERRAFORMS	: self.placeProjectTerraform,						
			SevoScreenEnums.PEDIA_SUMMONRITUALS	: self.placeSummonRitual,			
...
##--------	BUGFfH: End Add
			...
			SevoScreenEnums.PEDIA_IMPROVEMENTS_PRIMARY	: self.placeImprovementsPrimary,
##			SevoScreenEnums.PEDIA_IMPROVEMENTS_SECONDARY	: self.placeImprovementsSecondary,			
...
##--------	BUGFfH: End Add
		...
		self.mapScreenFunctions = {
			SevoScreenEnums.PEDIA_TECHS			: self.pediaTech,
			SevoScreenEnums.PEDIA_SPELLRESEARCH	: SevoPediaSpellResearch.SevoPediaSpellResearch(self),			
			SevoScreenEnums.PEDIA_UNITS			: self.pediaUnit,
			SevoScreenEnums.PEDIA_SUMMONS		: SevoPediaSummon.SevoPediaSummon(self),			
			SevoScreenEnums.PEDIA_UNIT_CATEGORIES	: SevoPediaUnitChart.SevoPediaUnitChart(self),
##--------	BUGFfH: Added by Denev 2009/08/12
			SevoScreenEnums.PEDIA_HEROES		: self.pediaUnit,
##--------	BUGFfH: End Add
			SevoScreenEnums.PEDIA_PROMOTIONS	: self.pediaPromotion,
			SevoScreenEnums.PEDIA_PROMOTIONS_CLASS	: self.pediaPromotion,
			SevoScreenEnums.PEDIA_PROMOTIONS_DISCIPLINE	: self.pediaPromotion,
			SevoScreenEnums.PEDIA_PROMOTIONS_HEROIC	: self.pediaPromotion,
##--------	BUGFfH: Added by Denev 2009/08/12
			...
			SevoScreenEnums.PEDIA_GEAR			: SevoPediaGear.SevoPediaGear(self),			
...
##--------	BUGFfH: End Add
			...
			SevoScreenEnums.PEDIA_DISTRICTS		: self.pediaBuilding,
			SevoScreenEnums.PEDIA_PALACES		: self.pediaBuilding,			
			SevoScreenEnums.PEDIA_NATIONAL_WONDERS	: self.pediaBuilding,
			SevoScreenEnums.PEDIA_GREAT_WONDERS	: self.pediaBuilding,
			SevoScreenEnums.PEDIA_CITY_ENCHANTMENTS	: self.pediaBuilding,			
			SevoScreenEnums.PEDIA_PROJECTS		: self.pediaProject,
			SevoScreenEnums.PEDIA_PROJECTGLOBALS	: SevoPediaProjectGlobal.SevoPediaProjectGlobal(self),
			SevoScreenEnums.PEDIA_PROJECTTERRAFORMS	: SevoPediaProjectTerraform.SevoPediaProjectTerraform(self),			
			SevoScreenEnums.PEDIA_SUMMONRITUALS	: SevoPediaSummonRitual.SevoPediaSummonRitual(self),			
...
##--------	BUGFfH: End Add
			...
			SevoScreenEnums.PEDIA_IMPROVEMENTS_PRIMARY	: SevoPediaImprovement.SevoPediaImprovement(self),
##			SevoScreenEnums.PEDIA_IMPROVEMENTS_SECONDARY	: SevoPediaImprovement.SevoPediaImprovement(self),			
...
##--------	BUGFfH: End Add
	...
	def pediaJump(self, iCategory, iItem, bRemoveFwdList, bIsLink):
		...
		if (not self.pediaHistory):
			bAddToHistory = True
		elif (iCategory != SevoScreenEnums.PEDIA_MAIN or iItem == SevoScreenEnums.PEDIA_PROMOTION_TREE or iItem == SevoScreenEnums.PEDIA_HINTS):
...
#			iCategory += self.pediaBuilding.getBuildingType(iItem)
			iBuildingType = self.pediaBuilding.getBuildingType(iItem)
			if iBuildingType == SevoScreenEnums.TYPE_PALACE:
				iCategory = SevoScreenEnums.PEDIA_PALACES
			if iBuildingType == SevoScreenEnums.TYPE_DISTRICT:
				iCategory = SevoScreenEnums.PEDIA_DISTRICTS			
			if iBuildingType == SevoScreenEnums.TYPE_NATIONAL:
				iCategory = SevoScreenEnums.PEDIA_NATIONAL_WONDERS
			if iBuildingType == SevoScreenEnums.TYPE_WORLD:
				iCategory = SevoScreenEnums.PEDIA_GREAT_WONDERS
			if iBuildingType == SevoScreenEnums.TYPE_CITYENCHANTMENT:
				iCategory = SevoScreenEnums.PEDIA_CITY_ENCHANTMENTS				
##--------	BUGFfH: End Modify
##--------	BUGFfH: Added by Denev 2009/08/12
		elif (iCategory == SevoScreenEnums.PEDIA_UNITS):
			iUnitType = self.pediaUnit.getUnitType(iItem)
			if iUnitType == SevoScreenEnums.TYPE_SUMMON:
				iCategory = SevoScreenEnums.PEDIA_SUMMONS
			elif iUnitType == SevoScreenEnums.TYPE_WORLDUNIT:
				iCategory = SevoScreenEnums.PEDIA_HEROES
		elif (iCategory == SevoScreenEnums.PEDIA_TECHS):
			iTechType = self.pediaTech.getTechType(iItem)
			if iTechType == SevoScreenEnums.TYPE_SPELLRESEARCH:
				iCategory = SevoScreenEnums.PEDIA_SPELLRESEARCH
			...
			elif iPromotionType == SevoScreenEnums.TYPE_CLASS:
				iCategory = SevoScreenEnums.PEDIA_PROMOTIONS_CLASS
			elif iPromotionType == SevoScreenEnums.TYPE_DISCIPLINE:
				iCategory = SevoScreenEnums.PEDIA_PROMOTIONS_DISCIPLINE
			elif iPromotionType == SevoScreenEnums.TYPE_HEROIC:
				iCategory = SevoScreenEnums.PEDIA_PROMOTIONS_HEROIC
		elif (iCategory == SevoScreenEnums.PEDIA_PROJECTS):
			iProjectType = self.pediaProject.getProjectType(iItem)
			if iProjectType == SevoScreenEnums.TYPE_SUMMONRITUAL:
				iCategory = SevoScreenEnums.PEDIA_SUMMONRITUALS
			elif iProjectType == SevoScreenEnums.TYPE_PROJECTTERRAFORM:
				iCategory = SevoScreenEnums.PEDIA_PROJECTTERRAFORMS				
			elif iProjectType == SevoScreenEnums.TYPE_PROJECTGLOBAL:
				iCategory = SevoScreenEnums.PEDIA_PROJECTGLOBALS								
			...
			elif iImprovementType == SevoScreenEnums.TYPE_PRIMARY:
				iCategory = SevoScreenEnums.PEDIA_IMPROVEMENTS_PRIMARY
#			elif iImprovementType == SevoScreenEnums.TYPE_SECONDARY:
#				iCategory = SevoScreenEnums.PEDIA_IMPROVEMENTS_SECONDARY				
##--------	BUGFfH: End Add
...
##--------	BUGFfH: End Add
		...
		if (iCategory not in (SevoScreenEnums.PEDIA_PROMOTION_TREE, SevoScreenEnums.PEDIA_HINTS)):
...
##--------	BUGFfH: Added by Denev 2009/08/17
			screen = self.getScreen()
...
##--------	BUGFfH: End Add
	...
	def setPediaCommonWidgets(self):
		...
		self.szCategorySpellResearch	= localText.getText("TXT_KEY_PEDIA_CATEGORY_SPELLRESEARCH", ())		
		self.szCategoryUnits			= localText.getText("TXT_KEY_PEDIA_CATEGORY_UNIT", ())
		self.szCategorySummons			= localText.getText("TXT_KEY_PEDIA_CATEGORY_SUMMON", ())		
#		self.szCategoryUnitUpgrades		= localText.getText("TXT_KEY_PEDIA_CATEGORY_UNIT_UPGRADES", ())
		...
		self.szCategoryPromotionsVeteran= localText.getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION_CLASS", ())
		self.szCategoryPromotionsElite	= localText.getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION_DISCIPLINE", ())
		self.szCategoryPromotionsHeroic	= localText.getText("TXT_KEY_PEDIA_CATEGORY_PROMOTION_HEROIC", ())
		...
		self.szCategoryDistricts		= localText.getText("TXT_KEY_PEDIA_CATEGORY_DISTRICTS", ())
		self.szCategoryPalaces			= localText.getText("TXT_KEY_PEDIA_CATEGORY_PALACES", ())		
		...
		self.szCategoryCityEnchantments	= localText.getText("TXT_KEY_PEDIA_CATEGORY_CITY_ENCHANTMENTS", ())		
		self.szCategoryProjects			= localText.getText("TXT_KEY_PEDIA_CATEGORY_PROJECT", ())
		self.szCategoryProjectTerraforms= localText.getText("TXT_KEY_PEDIA_CATEGORY_PROJECTTERRAFORM", ())		
		self.szCategoryProjectGlobals	= localText.getText("TXT_KEY_PEDIA_CATEGORY_PROJECTGLOBAL", ())				
		self.szCategorySummonRituals	= localText.getText("TXT_KEY_PEDIA_CATEGORY_SUMMONRITUAL", ())		
		...
		self.szCategoryImprovementsPrimary = localText.getText("TXT_KEY_PEDIA_CATEGORY_IMPROVEMENT_PRIMARY", ())
#		self.szCategoryImprovementsSecondary = localText.getText("TXT_KEY_PEDIA_CATEGORY_IMPROVEMENT_SECONDARY", ())		
		...
		self.szCategoryConceptsWildmana	= localText.getText("TXT_KEY_PEDIA_CATEGORY_CONCEPT_WILDMANA", ())
		self.szCategoryWildmanaGuides	= localText.getText("TXT_KEY_PEDIA_CATEGORY_WILDMANA_GUIDE", ())		
...
##--------	BUGFfH: Added by Denev 2009/10/05
		self.szCategoryHeroes		= localText.getText("TXT_KEY_PEDIA_CATEGORY_HERO", ())
		...
		self.szCategoryGear			= localText.getText("TXT_KEY_PEDIA_CATEGORY_GEAR", ())		
...
##--------	BUGFfH: End Add
		...
		self.categoryList = [
			...
			["TECHS",	self.szCategorySpellResearch],			
			["UNITS",	self.szCategoryUnits],
			["UNITS",	self.szCategorySummons],			
#			["UNITS",	self.szCategoryUnitUpgrades],

##--------	BUGFfH: Added by Denev 2009/08/12
			["UNITS",	self.szCategoryHeroes],
##--------	BUGFfH: End Add

			["UNITS",	self.szCategoryUnitCategories],
			["PROMOTIONS",	self.szCategoryPromotions],
			["PROMOTIONS",	self.szCategoryPromotionsVeteran],
			["PROMOTIONS",	self.szCategoryPromotionsElite],
			["PROMOTIONS",	self.szCategoryPromotionsHeroic],
			["PROMOTIONS",	self.szCategoryPromotionTree],

##--------	BUGFfH: Added by Denev 2009/10/05
			["PROMOTIONS",	self.szCategoryEffects],
			["PROMOTIONS",	self.szCategoryEquipments],
			["PROMOTIONS",	self.szCategoryGear],			
...
##--------	BUGFfH: End Add
			...
			["BUILDINGS",	self.szCategoryDistricts],
			["BUILDINGS",	self.szCategoryPalaces],			
			["BUILDINGS",	self.szCategoryNationalWonders],
			["BUILDINGS",	self.szCategoryGreatWonders],
			["BUILDINGS",	self.szCategoryCityEnchantments],						
			["BUILDINGS",	self.szCategoryProjects],
			["BUILDINGS",	self.szCategoryProjectTerraforms],			
			["BUILDINGS",	self.szCategoryProjectGlobals],						
			["BUILDINGS",	self.szCategorySummonRituals],			
...
##--------	BUGFfH: End Add
			...
			["TERRAINS",	self.szCategoryImprovementsPrimary],
#			["TERRAINS",	self.szCategoryImprovementsSecondary],
...
##--------	BUGFfH: Added by Denev 2009/08/12
			"SPELLS"	: u"%c  " %(CyGame().getSymbolID(FontSymbols.STAR_CHAR)),
##--------	BUGFfH: End Add
			}
	...
	def placeTechs(self):
		self.list = self.getTechList(SevoScreenEnums.TYPE_REGULAR)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_TECH, gc.getTechInfo)

	def placeSpellResearch(self):
		self.list = self.getTechList(SevoScreenEnums.TYPE_SPELLRESEARCH)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_TECH, gc.getTechInfo)
		
	def getTechList(self, iType = None):
		return self.getSortedList(gc.getNumTechInfos(), gc.getTechInfo, iType, self.pediaTech.getTechType)
	...
	def placeSummons(self):
		self.list = self.getUnitList(SevoScreenEnums.TYPE_SUMMON)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_UNIT, gc.getUnitInfo)
...
##--------	BUGFfH: End Modify
	...
	def placeDistricts(self):
		self.list = self.getBuildingList(SevoScreenEnums.TYPE_DISTRICT)

		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_BUILDING, gc.getBuildingInfo)
	
	def placePalaces(self):
		self.list = self.getBuildingList(SevoScreenEnums.TYPE_PALACE)
...
##--------	BUGFfH: End Modify
	...
	def placeCityEnchantments(self):
		self.list = self.getBuildingList(SevoScreenEnums.TYPE_CITYENCHANTMENT)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_BUILDING, gc.getBuildingInfo)
...
##--------	BUGFfH: End Delete
	...
	def placeProjectTerraform(self):
		self.list = self.getProjectList(SevoScreenEnums.TYPE_PROJECTTERRAFORM)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROJECT, gc.getProjectInfo)

	def placeProjectGlobal(self):
		self.list = self.getProjectList(SevoScreenEnums.TYPE_PROJECTGLOBAL)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROJECT, gc.getProjectInfo)
		
	def placeSummonRitual(self):
		self.list = self.getProjectList(SevoScreenEnums.TYPE_SUMMONRITUAL)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROJECT, gc.getProjectInfo)
...
##--------	BUGFfH: Added by Denev 2009/10/06
	...
	def placePromotionsClass(self):
		self.list = self.getPromotionList(SevoScreenEnums.TYPE_CLASS)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROMOTION, gc.getPromotionInfo)

	def placePromotionsDiscipline(self):
		self.list = self.getPromotionList(SevoScreenEnums.TYPE_DISCIPLINE)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROMOTION, gc.getPromotionInfo)

	def placePromotionsHeroic(self):
		self.list = self.getPromotionList(SevoScreenEnums.TYPE_HEROIC)
		self.placeItems(WidgetTypes.WIDGET_PEDIA_JUMP_TO_PROMOTION, gc.getPromotionInfo)
...
##--------	BUGFfH: End Add
	...
	def placeWildmanaConcepts(self):
		self.list = self.getWildmanaConceptList()
		self.placeItems(WidgetTypes.WIDGET_PEDIA_DESCRIPTION, self.getWildmanaConceptInfo)
	
	def getWildmanaConceptInfo(self, id):
		info = gc.getWildmanaConceptInfo(id)
		if not self.isShortcutInfo(info) and not self.isStrategyInfo(info) and not self.isTraitInfo(info):
			return info
		return None
	
	def getWildmanaConceptList(self):
		return self.getSortedList(gc.getNumWildmanaConceptInfos(), gc.getWildmanaConceptInfo)	
		
	def placeWildmanaGuides(self):
		self.list = self.getWildmanaGuideList()
		self.placeItems(WidgetTypes.WIDGET_PEDIA_DESCRIPTION, gc.getWildmanaGuideInfo)
...
##--------	BUGFfH: End Add
		...
		for i in range(gc.getNumWildmanaConceptInfos()):
			if (gc.getWildmanaConceptInfo(i).isMatchForLink(szLink, False)):
				return self.pediaJump(SevoScreenEnums.PEDIA_WILDMANA_CONCEPTS, i, True, True)
		for i in range(gc.getNumWildmanaGuideInfos()):
			if (gc.getWildmanaGuideInfo(i).isMatchForLink(szLink, False)):
				return self.pediaJump(SevoScreenEnums.PEDIA_WILDMANA_GUIDES, i, True, True)
...
##--------	BUGFfH: Modified by Denev 2009/10/08
	...
	def getSortedList(self, numInfos, getInfo, iCategory = None, getCategory = None):
		...
		if not bSortDifferent:
			...
			for iPass in range(100):
				if bGear:
					if gc.getEquipmentCategoryInfo(iPass):
						szDescription = gc.getEquipmentCategoryInfo(iPass).getDescription()				
						infoList.append( (szDescription, -1, szDescription) )
						
					for iItemID in range(numInfos):
						if getInfo(iItemID):
							if getInfo(iItemID).getEquipmentCategory() == iPass:
								if ((None in (iCategory, getCategory) or getCategory(iItemID) == iCategory) and not getInfo(iItemID).isGraphicalOnly()):
									szDescription = getInfo(iItemID).getDescription()
									if szDescription[0:4] == "The ":
										infoList.append( (szDescription[4:], iItemID, szDescription) )
				...
				if bTrait:
					eGreen = gc.getInfoTypeForString("COLOR_GREEN")				
					if iPass == 0:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_BASIC",		())
						infoList.append( (szDescription, 0, szDescription) )												
					if iPass == 1:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_AGGRESSIVE",		())
						infoList.append( (szDescription, 0, szDescription) )						
					if iPass == 2:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_ARCANE",		())
						infoList.append( (szDescription, 0, szDescription) )						
					if iPass == 3:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_CREATIVE",		())
						infoList.append( (szDescription, 0, szDescription) )
					if iPass == 4:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_IMPERIAL",		())
						infoList.append( (szDescription, 0, szDescription) )
					if iPass == 5:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_CIVTRAIT",		())			
						infoList.append( (szDescription, 0, szDescription) )						
					if iPass == 6:
						szDescription = localText.getText("TXT_KEY_PEDIA_TRAITS_LEADER",		())
						infoList.append( (szDescription, 0, szDescription) )
					...
					for iItemID in range(numInfos):
						if getInfo(iItemID):
							...
							bAggressiveTrait = false
							bCreativeTrait = false
							bImperialTrait = false
							bArcaneTrait = false
							
							if gc.getTraitInfo(iItemID).isCultureTrait():
								bLeaderTrait = false
								bBasicTrait = true
								
							if(gc.getTraitInfo(iItemID).getPrereqTrait() != -1):
								bLeaderTrait = false
								if gc.getTraitInfo(iItemID).getPrereqTrait() == gc.getInfoTypeForString('TRAIT_AGGRESSIVE'):
									bAggressiveTrait = true
								elif gc.getTraitInfo(iItemID).getPrereqTrait() == gc.getInfoTypeForString('TRAIT_CREATIVE'):
									bCreativeTrait = true
								elif gc.getTraitInfo(iItemID).getPrereqTrait() == gc.getInfoTypeForString('TRAIT_IMPERIALIST'):
									bImperialTrait = true
								elif gc.getTraitInfo(iItemID).getPrereqTrait() == gc.getInfoTypeForString('TRAIT_ARCANE'):
									bArcaneTrait = true
								else:
									bBasicTrait = true

							for i in range(gc.getNumCivilizationInfos()):
								if(gc.getCivilizationInfo(i).getCivTrait() == iItemID):
									bCivTrait = true
									bLeaderTrait = false																
						
							bValid = false	
							if (bLeaderTrait and iPass == 6):
								bValid = true
							if (bBasicTrait and iPass == 0):
								bValid = true
							if (bAggressiveTrait and iPass == 1):
								bValid = true
							if (bArcaneTrait and iPass == 2):
								bValid = true
							if (bCreativeTrait and iPass == 3):
								bValid = true
							if (bImperialTrait and iPass == 4):
								bValid = true

							if (bCivTrait and iPass == 5):
								bValid = true
