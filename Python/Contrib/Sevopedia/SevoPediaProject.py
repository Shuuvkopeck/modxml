...
#			return SevoScreenEnums.TYPE_TEAM
		if (gc.getProjectInfo(iProject).getSummonUnitType()!=-1):
			return SevoScreenEnums.TYPE_SUMMONRITUAL						
		elif (gc.getProjectInfo(iProject).getNumTerrainChanges()>0):
			return SevoScreenEnums.TYPE_PROJECTTERRAFORM								
		elif (gc.getProjectInfo(iProject).isGlobalEnchantment()):
			return SevoScreenEnums.TYPE_PROJECTGLOBAL										
		else:
