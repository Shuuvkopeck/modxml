...
#added Sephi	
		...
		self.X_EXIT = screen.getXResolution()-30
		self.Y_EXIT = screen.getYResolution()-40
		
		self.X_SLIDERS += screen.centerX(0)
		self.X_INCOME += screen.centerX(0)
		self.X_EXPENSES += screen.centerX(0)

		
		self.Y_LOCATION += screen.centerY(0)		
		self.Y_TREASURY += screen.centerY(0)
		self.Y_TITLE += screen.centerY(0)		
