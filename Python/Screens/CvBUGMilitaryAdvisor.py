...
#added Sephi	
	...
	def setValues(self):
		...
		self.X_GROUP_LIST = 20+screen.centerX(0)
		self.Y_GROUP_LIST = 190+screen.centerY(0)

		self.X_MAP = 20+screen.centerX(0)
		self.Y_MAP = 220+screen.centerY(0)
		
		self.H_MAP_MAX = 470+screen.centerX(0)
		
		self.X_TEXT = 625+screen.centerX(0)
		self.Y_TEXT = 190+screen.centerY(0)
						
		self.X_LEADERS = 20+screen.centerX(0)
		self.Y_LEADERS = 80+screen.centerY(0)
		
		self.Y_TITLE = 12+screen.centerY(0)	
		self.X_EXIT = 994+screen.centerX(0)
		self.Y_EXIT = 726+screen.centerY(0)
		
		self.SETTINGS_PANEL_X1 = 50+screen.centerX(0)
		self.SETTINGS_PANEL_X2 = 355+screen.centerX(0)
		self.SETTINGS_PANEL_X3 = 660+screen.centerX(0)
		self.SETTINGS_PANEL_Y = 150+screen.centerY(0)

		self.Y_LINK = self.H_SCREEN - 40
...
#		screen.setDimensions(screen.centerX(0), screen.centerY(0), self.W_SCREEN, self.H_SCREEN)
		...
		if CityScreenOpt.isDisableFlavor():					
			...
			screen.addPanel( "BackgroundFlavor", u"", u"", True, False, 0, 0, xResolution, yResolution, PanelStyles.PANEL_STYLE_STANDARD)
			
			pPlayer = gc.getPlayer(gc.getGame().getActivePlayer())
			iCiv=pPlayer.getCivilizationType()
			if iCiv==gc.getInfoTypeForString("CIVILIZATION_AMURITES"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/amurites_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_BALSERAPHS"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/balseraphs_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_BANNOR"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/bannor_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_CALABIM") or iCiv==gc.getInfoTypeForString("CIVILIZATION_ARISTRAKH"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/calabim_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_CLAN_OF_EMBERS"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/clan_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_DOVIELLO"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/doviello_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_ELOHIM"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/elohim_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )				
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_FAERIES"):						
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/faeries_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )													
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_FROZEN"):						
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/frozen_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_GRIGORI") or iCiv==gc.getInfoTypeForString("CIVILIZATION_DURAL"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/grigori_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )				
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_HIPPUS"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/hippus_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_ILLIANS"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/illians_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_INFERNAL"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/infernal_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_KURIOTATES"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/kuriotates_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_KHAZAD") or iCiv==gc.getInfoTypeForString("CIVILIZATION_AUSTRIN") or iCiv==gc.getInfoTypeForString("CIVILIZATION_JOTNAR"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/khazad_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_LANUN"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/lanun_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_LJOSALFAR"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/ljosalfar_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_LUCHUIRP"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/luchuirp_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_MALAKIM"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/malakim_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_MAZATL"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/mazatl_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_MERCURIANS"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/mercurians_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_SCIONS"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/scions_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )										
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_SHEAIM"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/sheaim_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )		
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_SIDAR"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/sidar_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )					
			elif iCiv==gc.getInfoTypeForString("CIVILIZATION_SVARTALFAR"):				
				screen.addDrawControl( "BackgroundFlavor", "Art/Interface/CityScreen/svartalfar_back.dds", 0, 0, xResolution, yResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )							
			screen.show( "BackgroundFlavor")
...
#				BugUtil.debug("%s / %s : %d (%d)" % (grouping.grouping.title, group.group.title, group.size(), group.isEmpty()))
		...
		for group1 in grouping1.itergroups():
			...
			szDescription = "> " + group1.group.title + u" (%d)" % len(units1)
			if (bGroup1Selected):
