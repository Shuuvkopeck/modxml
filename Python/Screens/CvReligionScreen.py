...
#added Sephi	
	...
	def setValues(self):
		...
		self.X_ANARCHY = 21+screen.centerX(0)
		self.Y_ANARCHY = 726+screen.centerY(0)
	
		# BlackArchon/LordShaggynator: The text boxes shouldn't overlap
		#self.LEFT_EDGE_TEXT = 10+screen.centerX(0)/2-40
		self.LEFT_EDGE_TEXT = 10
		self.X_RELIGION_START = 180
		self.Y_RELIGION = 35
		self.Y_FOUNDED = 90
		...
		self.X_RELIGION_AREA = 45+screen.centerX(0)
		self.Y_RELIGION_AREA = 84+screen.centerY(0)

		self.X_CITY1_AREA = 45+screen.centerX(0)
		self.X_CITY2_AREA = 522+screen.centerX(0)
		self.Y_CITY_AREA = 282+screen.centerY(0)
