...
def init():
	...
	if not ALL_TROPHIES:
		ALL_TROPHIES=[
			...
			Trophy("TROPHY_FEAT_ASCENSION",CyTranslator().getText("TXT_KEY_TROPHY_FEAT_ASCENSION", ()),', ,Art/Interface/Buttons/Units/Units_Atlas1.dds,5,9','art/interface/buttons/trophies/Auric AscendedGrey.dds'),
			Trophy("TROPHY_FEAT_BABOON",CyTranslator().getText("TXT_KEY_TROPHY_FEAT_BABOON", ()),', ,Art/Interface/Buttons/Units/Units_Atlas3.dds,1,9','art/interface/buttons/trophies/BaboonGrey.dds'),
			...
			Trophy("TROPHY_FEAT_GRAND_MENAGERIE",CyTranslator().getText("TXT_KEY_TROPHY_FEAT_GRAND_MENAGERIE", ()),', ,Art/Interface/Buttons/Buildings/Buildings_Atlas1.dds,3,7','art/interface/buttons/trophies/Grand MenagerieGrey.dds'),
